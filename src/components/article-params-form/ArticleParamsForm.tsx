...
export const ArticleParamsForm = ({ defaultOptions, applyOptions }: ArticleParamsFormProps) => {
  ...
  const [currentOptions, setCurrentOptions] = useState<ArticleStateType>(defaultOptions); // Выбранные параметры
  ...
  const updateOption = (optionKey: keyof ArticleStateType, newValue: OptionType) => {
  ...
  return (
    <div ref={containerRef}>
      ...
      {/* Боковое меню */}
      <aside className={clsx(styles.container, { [styles.container_open]: menuVisible })}>
